...
CREATE OR REPLACE TRIGGER TRIG_VENTA_REINTEGRO
     BEFORE DELETE ON DETALLE_VENTA FOR EACH ROW
BEGIN
    UPDATE PRODUCTO
    SET EXISTENCIA= :OLD.CANTIDAD + EXISTENCIA
    WHERE ID_PRODUCTO = :OLD.PRODUCTO_ID_PRODUCTO;
END;
/

CREATE OR REPLACE TRIGGER TRIG_COMPRA_REINTEGRO
