            ...
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        ...
                        <x-jet-application-mark class="block h-12 w-auto hover:translate-x-0.5 transition-all" />
                    </a>
                </div>
...
Clientes
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @foreach($navLinks as $link)
                <x-jet-responsive-nav-link href="{{route($link['name'])}}" :active="request()->routeIs($link['name'])">
                    {{ __($link['text']) }}
