<x-app-layout>
    <div class="container p-5 my-5 bg-white shadow-lg rounded-lg">
        <div class="d-flex align-items-center justify-content-around"><h3 class="display-4 inline-block">
                Proveedores</h3> <a class="btn btn-success" href="{{route('proveedors.create')}}">Crear</a></div>
                    ...
                    <tr>
                        ...
                        <td class="d-flex justify-content-around">
                            ...
                            <a class="btn btn-danger" href="javascript:void(0)"
                               onclick="eliminarproveedor({{$proveedor->id_proveedor}})">Eliminar</a>
                        </td>

                        <form id="delete-proveedors-{{$proveedor->id_proveedor}}"
                              action="{{route('proveedors.destroy',['proveedor'=>$proveedor->id_proveedor])}}"
                              method="POST"
                              style="display: none;">
                            @csrf
                            @method('DELETE')
